						...
						<div class="row">
								...
								<div class="card">
									...
									<div class="card-body">
										...
										<div class="form-group row">
												...
												<div class="col-md-9">
													<input type="number" class="form-control" name="identifiant" id="identifiant" onblur="verifref(this);" >
												</div>
											</div>
											<div class="form-group row">
												<label class="col-md-3 col-form-label"  >Nom  </label>
												<div class="col-md-9">
													<input type="text" class="form-control" name="nom" id="nom" onblur="verifnom(this);">
												</div>
											</div>
											...
											<div class="form-group row">
												...
												<div class="col-md-9">
													<!--input type="file" class="form-control" name="url" id="url" -->
													<!--<select type="number" class="form-control" name="numCat" id="numCat">
	                                               <option default> Catégorie</option>
												   <option value="1">1</option>
                                                  <option value="2">2</option>
                                                  </select>-->
												  <select type="number" class="form-control" name="numCat">
	                                             <?PHP
                                               foreach($listecategories as $row){
	                                             ?>
	                                           <option value="<?PHP echo $row['numcat']; ?>"><?PHP echo $row['numcat']; ?>
	                                          </option>
	                                        <?PHP } ?>
                                            </select> 
											...
											<button type="submit" class="btn btn-primary mt-1 mb-0">Enregistrer</button>
							...
							<div class="col-lg-12 col-xl-6 col-md-12 col-sm-12">
								<div class="card">
									...
									<div class="card-body">
										<form class="form-horizontal" method="POST" action="ajoutCat.php" >
											<div class="form-group row">
												<label class="col-md-3 col-form-label">Numéro</label>
												<div class="col-md-9">
													<input type="number" class="form-control" name="numcat" onblur="verifref(this);" >
												</div>
											</div>
											<div class="form-group row">
												<label class="col-md-3 col-form-label">Nom </label>
												<div class="col-md-9">
													<input type="text" class="form-control" name="nomcat" onblur="verifnom(this);" >
												</div>
											</div>
											<button type="submit" class="btn btn-primary mt-1 mb-0">Enregistrer</button>
