				...
				<div class="app-content">
					<section class="section">
						...
						<div class="page-header">
							<h4 class="page-title">Gestion Commande</h4>
							<ol class="breadcrumb">
									...
									<div class="card-body">
										<form class="form-horizontal" >
                                                            ...
                                                            <div class="form-group row"">
                                                                <<label for="password-input" class="col-md-3 col-form-label">id client </label>
                                                                <div class="col-md-9"><input type="number" id="id_client" name="id_client" value="<?php echo $id_client;?>" class="form-control"><small class="help-block form-text" required></small></div>
                                                            </div>

                                                            <div class="form-group row"">
                                                                <label for="password-input" class="col-md-3 col-form-label">total </label></div>
                                                                <div class="col-md-9"><input type="number" id="total" name="total" value="<?php echo $total;?>" class="form-control"><small class="help-block form-text" required></small></div>
                                                            </div>
