					...
					<section class="section">
                        ...
                        <!--row open-->
								<div class="card">
									...
									<div class="card-body">
										<form class="form-horizontal"  method="POST" action="ajouter_evenement.php">
											<div class="form-group row">
												<label class="col-md-3 col-form-label"  >ID evenement  </label>
												<div class="col-md-9">
													<input type="text" class="form-control" name="ide" onblur="verifref(this);">
												</div>
											</div>
											<div class="form-group row">
												<label class="col-md-3 col-form-label"  > type evenement  </label>
												<div class="col-md-9">
													<input type="text" class="form-control" name="typee" onblur="verifnom(this);">
												</div>
											</div>
											...
											<div class="form-group row">
												...
												<div class="col-md-9">
													<input type="text" class="form-control" name="prixe" onblur="verifnom(this);">
												</div>
											</div>
											...
											<div class="form-group row mb-0">
												...
												<div class="col-md-9">
													<textarea class="form-control" type="textarea" name="descriptione"> </textarea>
												</div>
											</div>
