...
if (isset($_GET['idprod'])){
	$couponC=new couponC();
    $result=$couponC->getid($_GET['idprod']);
...
?>
										<form class="form-horizontal" method="POST" >
											<div class="form-group row">
												...
												<div class="col-md-9">
												<input type="text" class="form-control" readonly onblur="verifnom(this);" name="idprod" value="<?PHP echo $idprod ?>">
												</div>
											</div>
											<div class="form-group row">
												<label class="col-md-3 col-form-label">Nom du produit </label>
												<div class="col-md-9">
													<input type="text" class="form-control" onblur="verifref(this);" name="nomp" value="<?PHP echo $nomp?>"  >
												</div>
											</div>
											<div class="form-group row">
...
-->
											<div class="form-group row mb-0">
												<label class="col-md-3 col-form-label"> new date </label>
												<div class="col-md-9">
											...
											<div class="form-group row mb-0">
												...
												<div class="col-md-9">
													<input class="form-control" type="text" name="prix1" value="<?PHP echo $prix1 ?>">
												</div>
											</div>
											...
											<input type="hidden" name="idpp" value="<?PHP echo $_GET['idprod'];?>">
...
if (isset($_POST['modifier'])){
	...
	$couponC->modifiercoupon($promotion,$_POST['idpp']);
