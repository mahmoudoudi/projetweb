<?PHP
   ...
   $prod1C=new ProdC();
   $listeProds=$prod1C->afficherProds();
    ?>
<!DOCTYPE html>
<html lang="en">
			...
			<div class="main-wrapper" >
				...
				<nav class="navbar navbar-expand-lg main-navbar">
					<a class="header-brand" href="index-2.html">
						<img src="../assets/img/brand/logobanette.PNG" class="header-brand-image" alt="Splite-Admin  logo">
					</a>
										...
										<div id="table" class="table-responsive table-editable">
											...
											<table class="table table-bordered table-responsive-md table-striped text-center mb-0 text-nowrap">
												...
												<tr>	
													...
													<td>
														<span> <a href="modifier.php?identifiant=<?PHP echo $row['identifiant']; ?>"><input  type="submit" class="btn btn-warning btn-rounded btn-sm my-0" name="identifiant" value="Modifier"></a>
														</span>
											...
											<table class="table table-bordered table-responsive-md table-striped text-center mb-0 text-nowrap">
												...
												<tr>	
													...
													<form method="POST" action="supprimerProd.php">
														...
														<td>
														<span> <a href="modifierprod.php?identifiant=<?PHP echo $row['identifiant']; ?>"><input  type="submit" class="btn btn-warning btn-rounded btn-sm my-0" name="identifiant" value="Modifier"></a>
														</span>
