...
?>	
	...
	<head>
			...
			<title>Banette-Admin Dashboard</title>
		...
		<div id="app" class="page">
			<div class="main-wrapper">
				...
				<aside class="app-sidebar">
	                ...
	                <!--app-content open-->
	               <br/><br/><br/><br/><br/><br/> <div class="app-content">		
							<div class="row">
								<div class="col-xl-4 col-lg-12 col-md-12">
								<div class="card">
									<div class="card-body">
										<h4>Gérer les Employés</h4>
										<?php 
												$mysqli = new mysqli("localhost","root", "", "projetweb");
												$query = $mysqli->prepare("SELECT * from employe");
												$query->execute();
													$query->store_result();
													...
													echo "vous avez "; echo $rows; echo " employe(s).<br/>";
 											?>

										<button class="btn btn-primary mt-3" onclick="location.href = 'ajout-employe.php';">Ajouter</button>   <button class="btn btn-primary mt-3" onclick="location.href = 'tables-employe.php';">Consulter les Employés</button>
									</div>
								</div>
							</div>
								...
								<div class="card">
									<div class="card-body">
										<h4>Gérer les Recettes</h4>
										<?php 
												$mysqli = new mysqli("localhost","root", "", "projetweb");
												$query = $mysqli->prepare("SELECT * from finance");
												$query->execute();
													$query->store_result();
													...
													echo "vous avez "; echo $rows; echo " Recettes de caisses enregistrer.<br/>";
 											?>

										<button class="btn btn-primary mt-3" onclick="location.href = 'ajout-finance.php';">Ajouter</button>   <button class="btn btn-primary mt-3" onclick="location.href = 'tables-finance.php';">Consulter les Recettes</button>
									</div>
								</div>
							</div>
								...
								<div class="card">
									<div class="card-body">
										<h4>Gérer les Offres d'emplois</h4>
											<?php 
												$mysqli = new mysqli("localhost","root", "", "projetweb");
												...
												$query->store_result();
													...
													echo "vous avez creer "; echo $rows; echo " offres d'emplois,<br/>";
 											?>
 											<?php 
												$mysqli = new mysqli("localhost","root", "", "projetweb");
												$query = $mysqli->prepare("SELECT * from jobs where etat=1");
												$query->execute();
												$query->store_result();
													...
													echo " dans "; echo $rows; echo " encore a pourvoir.<br/>";
 											?>
										<button class="btn btn-primary mt-3" onclick="location.href = 'ajout-jobs.php';">Ajouter</button>   <button class="btn btn-primary mt-3" onclick="location.href = 'tables-jobs.php';">Consulter les Emplois</button>
									</div>
								</div>
							</div>
