...
$id = $_GET['edit'];
$emps=$db->query("SELECT * FROM  finance WHERE id=$id");
           while ($row = $emps->fetch()) {
            $id= $row['id'];
            $pain = $row['pain'];
            $patisserie = $row['patisserie'];
 			$viennoiserie=$row['viennoiserie'];
 			$divers=$row['divers'];
	...
	<div class="wave -three"></div>
		...
		<div id="app" class="page">
			<div class="main-wrapper" >
                ...
                <!--app-content open-->
				 <form method="POST" action="editfin.php">
				<div class="app-content">
					<section class="section">

                        <!--page-header open-->
						<div class="page-header">
							<h4 class="page-title">Gestion Commande</h4> </div>
						<!--page-header closed-->
									...
									<div class="card-body">
										<form class="form-horizontal" >
											<div class="form-group row"">
                                                            ...
                                                            <div class="form-group row"">
                                                                <label for="password-input" class="col-md-3 col-form-label">pain </label>
                                                                <div class="col-md-9"><input type="text" id="pain" name="pain" value="<?php echo $pain;?>" class="form-control"><small class="help-block form-text" required></small></div><br/>

                                                            <div class="form-group row"">
                                                                <label for="password-input" class="col-md-3 col-form-label">patisserie </label>
                                                                <div class="col-md-9"><input type="text" id="patisserie" name="patisserie" value="<?php echo $patisserie;?>" class="form-control"><small class="help-block form-text" required></small></div><br/>
                                                            </div><br/>
                                                             <div class="form-group row"">
                                                                <label for="password-input" class="col-md-3 col-form-label">viennoiserie</label>
                                                                <div class="col-md-9"><input type="text" id="viennoiserie" name="viennoiserie" value="<?php echo $viennoiserie;?>" class="form-control"><small class="help-block form-text" required></small></div><br/>
                                                            </div><br/>
                                                              <div class="form-group row"">
                                                                <label for="password-input" class="col-md-3 col-form-label">divers</label>
                                                                <div class="col-md-9"><input type="text" id="divers" name="divers" value="<?php echo $divers;?>" class="form-control"><small class="help-block form-text" required></small></div><br/>
                                                            </div><br/>
                                                               <div class="form-group row"">
                                                                <label for="password-input" class="col-md-3 col-form-label">premiere</label>
                                                                <div class="col-md-9"><input type="text" id="premiere" name="premiere" value="<?php echo $premiere;?>" class="form-control"><small class="help-block form-text" required></small></div><br/>
                                                            </div><br/>
                                                            <div class="form-group row"">
                                                                <label for="password-input" class="col-md-3 col-form-label">charge</label>
                                                                <div class="col-md-9"><input type="text" id="charge" name="charge" value="<?php echo $charge;?>" class="form-control"><small class="help-block form-text" required></small></div><br/>
                                                            </div><br/>
                                                             <div class="form-group row"">
                                                                <label for="password-input" class="col-md-3 col-form-label">Recette</label>
                                                                <div class="col-md-9"><input type="text" id="recette" name="recette" value="<?php echo $recette;?>" class="form-control"><small class="help-block form-text" required></small></div><br/>
                                                            </div><br/>
                                                             <div class="form-group row"">
                                                                <label for="password-input" class="col-md-3 col-form-label">Net</label>
                                                                <div class="col-md-9"><input type="text" id="net" name="net" value="<?php echo $net;?>" class="form-control"><small class="help-block form-text" required></small></div><br/>
                                                            </div><br/>
