                               ...
                               <div class="col-lg-12 col-xl-6 col-md-12 col-sm-12">
								<div class="card">
									<div class="card-header">
										<h4>Modifier Produit (Pâtissserie)</h4>
									</div>
									<div class="card-body">
<?php
...
if (isset($_GET['identifiant'])){
	$prodC=new ProdC();
    $result=$prodC->recupererProd($_GET['identifiant']);
...
if (isset($_POST['modifier'])){
	$prod=new Prod($_POST['identifiant'],$_POST['nom'],$_POST['quantite'],$_POST['prix']);
	$prodC->modifierProd($prod,$_POST['identifiant_ini']);
	echo $_POST['identifiant_ini'];
