		...
		<div id="app" class="page">
			<div class="main-wrapper" >
				...
				<nav class="navbar navbar-expand-lg main-navbar">
					<a class="header-brand" href="../../frontend/views/product.php">
						<img src="images/logobanette.png" class="header-brand-img" alt="Splite-Admin  logo">
					</a>
...
<br>
						...
						<li class="slide">
							<a class="side-menu__item active" data-toggle="slide" href="#"><i class="side-menu__icon fa fa-table"></i><span class="side-menu__label">Gestion commande</span></a>
							<ul class="slide-menu">
                                    ...
                                    <tr>
                                        ...
                                        <td>
											  ...
											  <form method="POST" action="affichercontenucommande.php">
											        <button name="contenu" ><i class="glyphicon glyphicon-eye-open"></i></button>
                                        ...
                                        <td><?php echo $row["lieuLivraison"] ; ?></td>
										  ...
										  <td>
											  ...
											  <form method="POST" action="validercommande.php">
											        <button name="valider"><i class="glyphicon glyphicon-ok"></i></button>
											        <input type="hidden" value="<?PHP echo $row['idCommande']; ?>" name="idCommande">
											  </form> 	

										  <td> 
											  <form method="POST" action="supprimercommande.php">
											        <button name="supprimer" ><i class="glyphicon glyphicon-remove"></i></button>
											        <input type="hidden" value="<?PHP echo $row['idCommande']; ?>" name="idCommande">
											  </form> 
										  </td>
<td> 
											  <form method="POST" action="imprimer.php">
											        <button name="imprimer" ><i class="glyphicon glyphicon-print"></i> </button>
