...
<!-- Mirrored from www.spruko.com/demo/splite/historique.php by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 10 Feb 2019 18:34:37 GMT -->
<head>
					...
					<ul class="navbar-nav navbar-right">
						...
						<li class="dropdown"><a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle nav-link-lg d-flex">
							...
							<div class="dropdown-menu dropdown-menu-right">
								...
								<div class="dropdown-divider"></div><a class="dropdown-item" href="session.php"><i class="mdi  mdi-logout-variant mr-2"></i> <span>Logout</span></a>
							</div>
						</li>
					</ul>
				</nav>
					...
					<ul class="side-menu">
						...
						<li class="slide">
							...
							<ul class="slide-menu">
								...
								<li><a href="affichercommande.php" class="slide-item">commande</a></li>
							</ul>
						</li>
							...
							<div class="col-lg-12">
								<div class="card">
									<div class="card-header">
										<h4>Historique commande</h4>
									</div>
									<div class="card-body">
										<div class="table-responsive" >
                                            <input type="text" id="myInput" placeholder="Search..">
											<table id="myTable" class="table table-striped table-bordered border-t0 text-nowrap w-100" >
												<thead>
													<tr>
														<th class="wd-15p">ID client</th>
														<th class="wd-15p">ID commande</th>
...
<!-- Mirrored from www.spruko.com/demo/splite/historique.php by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 10 Feb 2019 18:34:41 GMT -->
</html>
<?php
  }
?>