<?PHP   
        ...
        $prod1C=new ProdC();
        $listeProduits=$prod1C->afficherProds();
...
<body class="animsition"> 
	...
	<!-- Title Page -->
	<section class="bg-title-page p-t-50 p-b-40 flex-col-c-m" style="background-image: url(Frontend/images/gateaux.jpg);">
						...
						<div class="col-sm-12 col-md-6 col-lg-4 p-b-50">
							...
							<div class="block2">
								<div class="block2-img wrap-pic-w of-hidden pos-relative block2-labelnew">
									<img src="Frontend/images/item-02.jpg" alt="IMG-PRODUCT">  <!--image-->
                                     <!--Ajout au panier-->
