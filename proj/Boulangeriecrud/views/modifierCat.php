...
?>
										<form class="form-horizontal" method="POST"> 
											<div class="form-group row">
												...
												<div class="col-md-9">
													<input type="number" class="form-control" name="numcat" value="<?PHP echo $numcat ?>" onblur="verifref(this);" >
												</div>
											</div>
											<div class="form-group row">
												<label class="col-md-3 col-form-label">Nom de Catégorie </label>
												<div class="col-md-9">
													<input type="text" class="form-control" name="nomcat" value="<?PHP echo $nomcat ?>" onblur="verifnom(this);" >
												</div>
											</div>
...
if (isset($_POST['modifier'])){
	...
	echo "<META http-equiv='refresh' content='0;URL=afficherCat.php'>";
