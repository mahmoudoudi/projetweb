			...
			<div class="main-wrapper" >
				...
				<aside class="app-sidebar mCustomScrollbar _mCS_1 mCS-autoHide mCS_no_scrollbar" style="overflow: visible;"><div id="mCSB_1" class="mCustomScrollBox mCS-minimal mCSB_vertical mCSB_outside" style="max-height: none;" tabindex="0"><div id="mCSB_1_container" class="mCSB_container mCS_y_hidden mCS_no_scrollbar_y" style="position:relative; top:0; left:0;" dir="ltr">
					<div class="app-sidebar__user active">
						<div class="dropdown user-pro-body text-center">
							<div class="nav-link pl-1 pr-1 leading-none ">
								<img src="assets/img/avatar/jdida.jpg" alt="user-img" class="avatar-xl rounded-circle mb-1 mCS_img_loaded">
					...
					<ul class="side-menu">
						...
						<li class="active">
							<a class="side-menu__item active" href="gestionevnmnt.php"><i class="side-menu__icon fa fa-edit"></i><span class="side-menu__label">Gestion Evenements</span></a>
						</li>
						<li>
				...
				</div></div><div id="mCSB_1_scrollbar_vertical" class="mCSB_scrollTools mCSB_1_scrollbar mCS-minimal mCSB_scrollTools_vertical" style="display: none;"><div class="mCSB_draggerContainer"><div id="mCSB_1_dragger_vertical" class="mCSB_dragger" style="position: absolute; min-height: 49.9922px; height: 0px; top: 0px;"><div class="mCSB_dragger_bar" style="line-height: 49px;"></div></div><div class="mCSB_draggerRail"></div></div></div></aside>
				<!--aside closed-->
...
?>
										<form class="form-horizontal" method="POST" >
											<div class="form-group row">
												...
												<div class="col-md-9">
												<input type="text" class="form-control" readonly onblur="verifnom(this);" name="ide" value="<?PHP echo $ide ?>">
												</div>
											</div>
											<div class="form-group row">
												<label class="col-md-3 col-form-label">Type d'evenement </label>
												<div class="col-md-9">
													<input type="text" class="form-control" onblur="verifref(this);" name="typee" value="<?PHP echo $typee?>"  >
												</div>
											</div>
											<div class="form-group row">
												<label class="col-md-3 col-form-label" for="example-email">Prix</label>
												<div class="col-md-9">
													<input class="form-control" name="prixe" type="text" value="<?PHP echo $prixe?>">
...
-->
											<div class="form-group row mb-0">
												<label class="col-md-3 col-form-label">Desc</label>
												<div class="col-md-9">
													<input class="form-control" type="textarea" name="descriptione" value="<?PHP echo $descriptione ?>">
												</div>
											</div>

											<button type="submit" class="btn btn-primary mt-1 mb-0"  value="modifier" name="modifier">Modifier</button>
											<input type="hidden" name="idpp" value="<?PHP echo $_GET['ide'];?>">
...
if (isset($_POST['modifier'])){
	...
	$event->modifierpanier($evenement,$_POST['idpp']);
