				...
				<div class="wrap-table-shopping-cart bgwhite">
					<table class="table-shopping-cart">
						<tr class="table-head">
							...
							<th class="column-6">ID commande</th>
							<th class="column-3">Contenu</th>
							<th class="column-3">Date</th>
							<th class="column-5">Total</th>
							<th class="column-3">Adresse</th>
							<th class="column-3">Prix livraison</th>
							<th class="column-8">Etat</th>
 ...
 <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
											  ...
											  <form method="POST" action="affichercontenucommande.php">
											        <button name="contenu" ><i class="ti-eye"></i></i></button>
                                    ...
                                    <tr>
                                        ...
                                        <td>
											  ...
											  <form method="POST" action="affichercontenucommande.php">
											        <button name="contenu" ><i class="ti-eye"></i></button>
											        <input type="hidden" value="<?PHP echo $row['idCommande']; ?>" name="idCommande">
											  </form> 										    
										  </td>
