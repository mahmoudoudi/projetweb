...
include ('C:/wamp64/www/EmployeFinance/back/entities/jobs.php');
include ('C:/wamp64/www/EmployeFinance/back/core/jobsJ.php');
$search_value=$_GET["search"];
$jobse=new jobsJ();
$listejobs=$jobse->recherche($search_value);
echo "test";
?>
