				...
				<aside class="app-sidebar">
					...
					<ul class="side-menu">
						...
						<li class="slide">
							...
							<ul class="slide-menu">
								<li><a href="formelements.html" class="slide-item"> Interface client</a></li>
				...
				<div class="app-content">
					<section class="section">
						...
						<div class="page-header">
							<h4 class="page-title">Interface client</h4>
							<ol class="breadcrumb">
...
if (isset($_GET['idc'])){
	$clientC=new clientC();
    $result=$clientC->getidc($_GET['idc']);
	foreach($result as $row){
		$idc=$row['idc'];
		$ndc=$row['ndc'];
		$mdp=$row['mdp'];
		$categoriec=$row['categoriec'];
...
?>
										<form class="form-horizontal" method="POST" >
											<div class="form-group row">
												...
												<div class="col-md-9">
												<input type="text" class="form-control" readonly onblur="verifref(this);" name="idc" value="<?PHP echo $idc ?>">
												</div>
											</div>
											<div class="form-group row">
												<label class="col-md-3 col-form-label">Nom de compte </label>
												<div class="col-md-9">
													<input type="text" class="form-control" onblur="verifnom(this);" name="ndc" value="<?PHP echo $ndc?>"  >
												</div>
											</div>
								...
								<div class="form-group row mb-0">
												...
												<div class="col-md-9">
												<input type="text" class="form-control" onblur="verifnom(this);" name="mdp" value="<?PHP echo $mdp?>"  >
												</div>
											</div>
								</br>
											...
											<div class="form-group row">
												...
												<div class="col-md-9">
													<select class="form-control" name="categoriec" value="<?PHP echo $categoriec?>">
...
if (isset($_POST['modifier'])){
	...
	$clientC->modifierclient($client,$_POST['idcc']);
