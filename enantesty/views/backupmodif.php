...
?>
										<form class="form-horizontal" method="POST">
											...
											<div class="form-group row">
												<label class="col-md-3 col-form-label">Nom du Coupon </label>
												<div class="col-md-9">
													<input type="text" class="form-control" value="<?PHP echo $ndc ?>" name="ndc" onblur="verifnom(this);">
												</div>
											</div>
											<!--<div class="form-group row">
												<label class="col-md-3 col-form-label">Réference </label>
											...
											<div class="form-group row">
												<label class="col-md-3 col-form-label" for="example-email">Pourcentage</label>
												<div class="col-md-9">
													<select class="form-control" name="mdp" value="<?PHP echo $mdp ?>">
														<option>5%</option>
														<option>10%</option>
														<option>15%</option>
													</select>
...
-->
											<div class="form-group row mb-0">
												<label class="col-md-3 col-form-label">Date d'Expiration</label>
												<div class="col-md-9">
													<input class="form-control" type="date" name="categoriec" value="<?PHP echo $categoriec?>">
												</div>
											</div>
...
if (isset($_POST['modifier'])){
	...
	$clientC->modifierclient($client,$_POST['idc_ini']);
	echo $_POST['idc_ini'];
