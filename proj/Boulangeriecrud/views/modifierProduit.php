...
if (isset($_POST['modifier'])){
	$produit=new Produit($_POST['identifiant_ini'],$_POST['nom'],$_POST['url'],$_POST['numCat'],$_POST['quantite'],$_POST['prix']);
	$produitC->modifierProduit($produit,$_POST['identifiant_ini']);
	echo $_POST['identifiant_ini'];
	echo "<META http-equiv='refresh' content='0;URL=taboulangerie.php'>";
