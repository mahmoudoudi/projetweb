			...
			<div class="container-table-cart pos-relative">
				...
				?>
						<tr class="table-row">
							...
							<td class="column-2">Panier vide</td>
							...
							<td class="column-4">
								...
								<button name="Modifier" class="bg8 t-center eff2" ><span class="lnr lnr-pencil"></span></button>
								 </form>
							</td>
							<td class="column-5">
							  <form method="POST" action="supprimerproduit.php">
        <button name="supprimer" ><span class="lnr lnr-trash"></span></button>
        <input type="hidden" value="<?PHP echo $row['id']; ?>" name="id">  
  </form> 
							</td>
						</tr>
...
?>
			...
			<div class="bo9 w-size18 p-l-40 p-r-40 p-t-30 p-b-38 m-t-30 m-r-0 m-l-auto p-lr-15-sm">
				<div class="size15 trans-0-4">
					<!-- Button -->
					<a class="flex-c-m sizefull bg1 bo-rad-23 hov1 s-text1 trans-0-4" href="command.php">
						VALIDER
					</a>
				</div>
			</div>
				...
				<form method="POST" action="listecommande.php">
						<a class="flex-c-m sizefull bg1 bo-rad-23 hov1 s-text1 trans-0-4" href="listecommande.php">
