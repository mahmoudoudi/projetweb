			...
			<div class="main-wrapper" >
					...
					<ul class="navbar-nav navbar-right">
						...
						<li class="dropdown"><a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle nav-link-lg d-flex">
								<span class="mr-3 mt-2 d-none d-lg-block ">
									<span class="text-white">Hello,<span class="ml-1"> Yassine </span></span>
								</span>
							<span><img src="assets/img/avatar/jdida.jpg" alt="profile-user" class="rounded-circle w-32 mr-2"></span>
							</a>
							<div class="dropdown-menu dropdown-menu-right">
								<div class=" dropdown-header noti-title text-center border-bottom pb-3">
									<h5 class="text-capitalize text-dark mb-1">Med yassine  </h5>
									<h6 class="text-capitalize text-dark mb-1">mahmoudi </h6>
				...
				<aside class="app-sidebar">
					<div class="app-sidebar__user">
						<div class="dropdown user-pro-body text-center">
							<div class="nav-link pl-1 pr-1 leading-none ">
								<img src="assets/img/avatar/jdida.jpg" alt="user-img" class="avatar-xl rounded-circle mb-1">
								<span class="pulse bg-success" aria-hidden="true"></span>
							</div>
							<div class="user-info">
								<h6 class=" mb-1 text-dark">Yassine</h6>
					...
					<ul class="side-menu">
						...
						<li>
							<a class="side-menu__item" href="livraisons.php"><i class="side-menu__icon fe fe-grid"></i><span class="side-menu__label">Gestion livraison</span></a>
						</li>
						<li>
							<a class="side-menu__item" href="emptypage.html"><i class="side-menu__icon fe fe-map"></i><span class="side-menu__label">Gestion Livreur</span></a>
						</li>						
					...
					<section class="section">
                        ...
                        <!--row open-->
								<div class="card">
									...
									<div class="card-body">
										<form class="form-horizontal"  method="POST" action="ajouter_evenement.php" id="form">
											<div class="form-group row">
												<label class="col-md-3 col-form-label"  >ID evenement  </label>
												<div class="col-md-9">
													<input type="text" class="form-control" name="ide" onblur="verifref(this);" id="ide">
												</div>
											</div>
											<div class="form-group row">
												<label class="col-md-3 col-form-label"  > type evenement  </label>
												<div class="col-md-9">
													<input type="text" class="form-control" name="typee" onblur="verifnom(this);" id="typee">
												</div>
											</div>
											
											<div class="form-group row">
												<label class="col-md-3 col-form-label" for="example-email">prix </label>
												<div class="col-md-9">
													<input type="text" class="form-control" name="prixe" onblur="verifnom(this);" id="prixe">
												</div>
											</div>
											...
											<div class="form-group row mb-0">
												...
												<div class="col-md-9">
													<textarea class="form-control" type="textarea" name="descriptione" id="descriptione"> </textarea>
												</div>
											</div>
						...
						<div class="col-12">
								<div class="card">
									<div class="card-header">
										...
										<h4>Tableau des evenements</h4>
									</div>
									<div class="card-body">
										<div id="table" class="table-responsive table-editable">
											<table class="table table-bordered table-responsive-md table-striped text-center mb-0 text-nowrap">
												<tabody><tr>
													<th class="text-center" >ID evenement</th>
													<th class="text-center" >type d'evenement </th>
													<th class="text-center">description </th>
													<th class="text-center">prix d'evenement </th>
												...
												<?php 
													foreach( $listepanier as $row )
														{ ?>
													<tr>	
													<td class="pt-3-half" contenteditable="true"> <?php echo $row['ide']; ?> </td>
													<td class="pt-3-half" contenteditable="true"> <?php echo $row['typee']; ?> </td>
													<td class="pt-3-half" contenteditable="true"> <?php echo $row['descriptione']; ?> </td>
													<td class="pt-3-half" contenteditable="true"> <?php echo $row['prixe']; ?> </td>
													...
													<td><form method="POST" action="supprimerevenement.php">
														<span ><input  type="submit" class="btn btn-danger btn-rounded btn-sm my-0" name="Supprimer" value="Supprimer">
															<input type="hidden" value="<?php echo $row['ide']; ?>" name="ide"></span>
													...
													<td>
														<span > <a href="modifierevenement.php?ide=<?PHP echo $row['ide']; ?>"><input  type="submit" class="btn btn-warning btn-rounded btn-sm my-0" name="" value="Modifier"></a>
														</span>
