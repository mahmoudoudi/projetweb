<?PHP   
        ...
        $listeProduits=$produit1C->afficherProduitsparcat();
								...
								<div class="card export-database">
									...
									<div class="card-body">
										<div class="table-responsive">
											<div id="example_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer" >
												...
												<div class="row">
												  <div class="col-sm-12">
													 ...
													 <input class="rechnom" type="text" placeholder="Identifiant.." name="q"  >
												...
												<thead>
													...
													<th class="sorting_desc" tabindex="0" aria-controls="example" rowspan="1" colspan="1" aria-label="Url: activate to sort column ascending" style="width: 278px;">URL</th>
											...
											<div class="btn-list text-right">
												<a href="print_pdf.php" > <button type="button"  class="btn btn-danger btn-space m-t-5" name="generate_pdf">Génerer un PDF</button> </a>
