								...
								<div class="card export-database">
									...
									<div class="card-body">
										<div class="table-responsive">
												...
												<tbody>
													<?php if (isset($_POST['valider'])) { 
														$produit1C=new ProduitC();
                                                         $listeProduits=$produit1C->rechercherListeProduit($_POST['q']);
											...
											<div class="btn-list text-right">
													<button type="button" class="btn btn-danger btn-space m-t-5" name="pdf">Génerer un PDF</button>
