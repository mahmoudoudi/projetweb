...
$cin = $_GET['edit'];
$emps=$db->query("SELECT * FROM  employe WHERE cin=$cin");
									...
									<div class="card-body">
										<form class="form-horizontal" >
											<div class="form-group row"">
                                                                <label for="password-input" class="col-md-3 col-form-label">cin </label>
                                                             <div class="col-md-9"><input type="text" id="cin" name="cin" value="<?php echo $cin;?>" class="form-control"><small class="help-block form-text" required></small></div><br/>

                                                            <div class="form-group row"">
                                                                <label for="password-input" class="col-md-3 col-form-label">nom </label>
                                                                <div class="col-md-9"><input type="text" id="nom" name="nom" value="<?php echo $nom;?>" class="form-control"><small class="help-block form-text" required></small></div><br/>

                                                            <div class="form-group row"">
                                                                <label for="password-input" class="col-md-3 col-form-label">prenom </label>
                                                                <div class="col-md-9"><input type="text" id="prenom" name="prenom" value="<?php echo $prenom;?>" class="form-control"><small class="help-block form-text" required></small></div><br/>
                                                            </div><br/>
                                                             <div class="form-group row"">
                                                                <label for="password-input" class="col-md-3 col-form-label">tel</label>
                                                                <div class="col-md-9"><input type="text" id="tel" name="tel" value="<?php echo $tel;?>" class="form-control"><small class="help-block form-text" required></small></div><br/>
                                                            </div><br/>
                                                              <div class="form-group row"">
