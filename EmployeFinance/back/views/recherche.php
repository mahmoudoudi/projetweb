...
<?php
include ('C:/wamp64/www/EmployeFinance/back/entities/employe.php');
include ('C:/wamp64/www/EmployeFinance/back/core/employeE.php');
$search_value=$_GET["search"];
$employee=new employeE();
$listeemploye=$employee->recherche($search_value);
echo "test";
?>
