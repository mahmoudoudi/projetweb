				...
				<div class="app-content">
					<section class="section">
						...
						<div class="section-body">
                            ...
                            <!--row open-->
							                                  <!--Categorieeeeeeeeeeeeeeee-->
							<div class="col-md-12">
								<div class="card export-database">
									<div class="card-header">
										<h4>Table de Catégories</h4>
									</div>
									<div class="card-body">
										<div class="table-responsive">
											<div id="example_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer">
												...
												<div class="row">
												  <div class="col-sm-12">
												  <table id="example" class="table table-bordered border-t0 key-buttons text-nowrap w-100 dataTable no-footer" role="grid" aria-describedby="example_info" style="width: 1170px;">
												<thead>
													<tr role="row">
													<th class="sorting" tabindex="0" aria-controls="example" rowspan="1" colspan="1" aria-label="numcat: activate to sort column ascending" style="width: 189px;">Numéro de catégorie</th>
													<th class="sorting_desc" tabindex="0" aria-controls="example" rowspan="1" colspan="1" aria-label="nomcat: activate to sort column ascending" style="width: 278px;">Nom de catégorie</th>
