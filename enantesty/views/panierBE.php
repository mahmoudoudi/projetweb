...
$couponC=new couponC();
$listecoupon=$couponC->afficherpromotion();
				...
				<aside class="app-sidebar">
					...
					<ul class="side-menu">
						...
						<li class="slide">
							...
							<ul class="slide-menu">
								<li><a href="stat.php" class="slide-item">stat</a></li>
				...
				<div class="app-content">
					<section class="section">
						...
						<div class="page-header">
							<h4 class="page-title">Gestion promotion </h4>
							<!--<ol class="breadcrumb">
									...
									<div class="card-body">
										<form class="form-horizontal"  method="POST" action="ajouter_coupon.php">
											<div class="form-group row">
												<label class="col-md-3 col-form-label"  >ID produit </label>
												<div class="col-md-9">
													<input type="text" class="form-control" name="idprod" onblur="verifref(this);">
												</div>
											</div>
											<div class="form-group row">
												<label class="col-md-3 col-form-label"  >Nom du produit </label>
												<div class="col-md-9">
													<input type="text" class="form-control" name="nomp" onblur="verifnom(this);">
												</div>
											</div>
											...
											<div class="form-group row mb-0">
												<label class="col-md-3 col-form-label">prix avant promotion</label>
												<div class="col-md-9">
													<input class="form-control" type="text" name="prix1">
												</div>
											</div>
											...
											<table class="table table-bordered table-responsive-md table-striped text-center mb-0 text-nowrap">
												...
												<?php 
													foreach( $listecoupon as $row )
														{ ?>
													<tr>	
													<td class="pt-3-half" contenteditable="true"> <?php echo $row['idprod']; ?> </td>
													<td class="pt-3-half" contenteditable="true"> <?php echo $row['nomp']; ?> </td>
													...
													<td class="pt-3-half" contenteditable="true"> <?php echo $row['prix1']; ?> </td>
													<td class="pt-3-half">
													...
													<td><form method="POST" action="supprimercoupon.php">
														<span ><input  type="submit" class="btn btn-danger btn-rounded btn-sm my-0" name="Supprimer" value="Supprimer">
															<input type="hidden" value="<?php echo $row['idprod']; ?>" name="idC"></span>
													...
													<td>
														<span > <a href="modifiercoupon.php?idprod=<?PHP echo $row['idprod']; ?>"><input  type="submit" class="btn btn-warning btn-rounded btn-sm my-0" name="" value="Modifier"></a>
														</span>
...
<form method="post" action="rechercheid.php">
			<input type="text" name="q" placeholder="saisir le Pourcentage ">
<input type="submit" name="chr" value="chercher" >
</form>
