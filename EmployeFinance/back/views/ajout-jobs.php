...
<div class="wave -three"></div>
		...
		<div id="app" class="page">
			<div class="main-wrapper">
                ...
                <!--app-content open-->
				 <form method="POST" action="ajoutjobs.php">
									...
									<div class="card-body">
										<form class="form-horizontal" >
											...
											<div class="form-group row">
												<label class="col-md-3 col-form-label">Poste</label>
												<div class="col-md-9">
											...
											<div class="form-group row">
												<label class="col-md-3 col-form-label">Salaire</label>
												<div class="col-md-9">
											...
											<div class="form-group row">
												...
												<div class="col-md-9">
													<input class="form-control" type="text" name="horaire" >
												</div>
											</div>										
<label>etat</label>
